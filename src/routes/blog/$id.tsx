      ...
      <section className="blog__page">
        ...
        <div className="container">
          <div className="blog__page__mobile-head">
            <Link
              to={"/blog"}
              search={{ searchQuery: "", searchBlogFilters: [currentPost.category] }}
          ...
          <div className="blog__page__width">
            ...
            <p>
              ...
              Например, в какой-то момент компания решила сэкономить и жестко «пришила» логику расчета скидок прямо в
              ядро системы. Спустя год рынок изменился, маркетологи хотят запустить новую акцию, но разработчики
              разводят руками: чтобы поменять одну цифру, нужно пересобрать все приложение и молиться, чтобы не упала
              интеграция со складом. Это и есть налог на технический долг, который вы платите ежедневно.
            </p>
            <h3>
              «Главная ловушка — пытаться натянуть старые бизнес-процессы на новую систему. Это как вставить двигатель
              от Ferrari в телегу: шума много, а скорости нет».
            </h3>
            <p>
              Настоящая инвестиционная архитектура строится иначе. Она всегда «разомкнута». Мы верим в принцип
              API-first: система не должна быть вещью в себе.{" "}
              <strong>
                Любой модуль — будь то склад, финансы или CRM — обязан уметь общаться с внешним миром без посредников.
              </strong>{" "}
              Это дает бизнесу ту самую маневренность, когда вы за неделю подключаете новую курьерскую службу или
              выводите товары на маркетплейс, просто «воткнув» нужный коннектор в готовую розетку.
            </p>
            <p>
      ...
      <section className="other">
        <div className="container">
          <div className="other__top">
            ...
            <Link to={"/blog"} search={{ searchQuery: "", searchBlogFilters: [] }} className={"button ghost"}>
              Смотреть все
            </Link>
          </div>
